				...
				<Fade triggerOnce duration={2500}>
					<Slide triggerOnce direction="up">
						<AntoniaInfo>
							...
							<AntoniaHeaderInfo>
								<Paragraph>
									Hi! I&apos;m Antonia, a Frontend Developer
									with a passion for creating impactful
									digital experiences. Leveraging my
									background in academia, healthcare and youth
									work, I bring a deep understanding of human
									behavior to my projects. I take pride in
									designing products that excel in both
									aesthetics and usability. As a tenacious
									problem solver, I embrace challenges and
									enjoy collaborating with others to bring
									ideas to life. If you&apos;re seeking a
									fresh perspective and a tailored approach,
									look no further. Let&apos;s connect!
								</Paragraph>
							</AntoniaHeaderInfo>
							<LinksContainer>
								<Link
